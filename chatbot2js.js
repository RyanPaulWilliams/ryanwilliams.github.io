...
function getBotResponse(input) {
    ...
    const responses = {
        ...
        "services": "At RTS Labs, we are committed to providing a comprehensive range of technology services " +
         "that cater to your unique business needs. Whether you have a groundbreaking idea waiting to be brought to life or " +
...
function sendToSalesforce(name, email, company) {
    ...
    fetch(url, {
        ...
        headers: {
            ...
            "Authorization": "Bearer 00DHp000001tKCiMAM!AQwAQGLVk1VsHIbU1suFiqNYLunuEYjA37m2xNQfgwn.1WY0Dof2O6GGbKmgfVtz4aObGgz6nwWrMJrLNIrfmGbpEWxAYuqt",
